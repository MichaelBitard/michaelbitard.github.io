...
:lastname: Bitard
// Refs
:link-31: https://www.openstreetmap.org/#map=12/43.5994/1.4131
...
:link-camino-sources: https://gitlab-forge.din.developpement-durable.gouv.fr/pub/pnm-public/camino
...
* https://piaille.fr/@BitardMichael[@BitardMichael, role="external",window="_blank",alt="@BitardMichael"]
* https://github.com/MichaelBitard[https://github.com/MichaelBitard, role="external",window="_blank"]
...
{link-camino-sources}[Les sources de Camino, role="external", window="_blank"]
